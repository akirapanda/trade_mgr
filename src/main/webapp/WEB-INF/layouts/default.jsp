...
<html>
<head>
<title>Trade System - Demo:<sitemesh:title/></title>
...
<link href="${ctx}/static/bootstrap/2.2.2/css/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet" />
<link href="${ctx}/static/bootstrap/2.2.2/css/datepicker.css" type="text/css" rel="stylesheet" />
<link href="${ctx}/static/jquery-ui-1.10.3/themes/base/jquery-ui.css" type="text/css" rel="stylesheet" />
...
<script src="${ctx}/static/bootstrap/2.2.2/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
